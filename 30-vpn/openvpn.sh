...
##### this total script comes under headless mode--> launcing the openvpn server and configuring the openvpn through script
...
# 4. DNS configuration: use Access Server host DNS 8.8.8.8 is primary DNS, 1.1.1.1 is secondary DNS
